import { AffineMatrix, Collider, Animation, type Frame, Graphic, Shape, Sprite, SpriteSheet, Vector, vec, AnimationStrategy, ImageSource, BoundingBox } from "excalibur";
...
import { type Properties, mapProps } from "./properties";
